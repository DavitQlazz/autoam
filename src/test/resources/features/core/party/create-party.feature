Feature: Party-Creating Individual Party
  ...
  Scenario Outline:Create new Party, fill all fields, compare data and after removing the task.
    ...
    Examples:
      | date       | phone     | code           | gender | citizenship | primary email           | secondary email           |
      | 3 JUL 2017 | 123456789 | Armenia (+374) | Male   | Uganda      | primary@synisystest.com | secondary@synisystest.com |
